                ...
                <div class="conteneur-grid">
                    ...
                    <div class="grid-item">
                        ...
                        <select id="endroit" name="endroit">
                            <option value="Groove Gallery"@if( $activite->endroit == "Groove Gallery" ) selected @endif>Groove Gallery</option>
                            <option value="Urban Beats Arena"@if( $activite->endroit == "Urban Beats Arena") selected @endif>Urban Beats Arena</option>
                            <option value="Graffiti Groove Stage"@if( $activite->endroit == "Graffiti Groove Stage") selected @endif>Graffiti Groove Stage</option>
                            <option value="ColorSplash Sound Hub"@if( $activite->endroit == "ColorSplash Sound Hub") selected @endif>ColorSplash Sound Hub</option>
                            <option value="Artistic Beats Pavilion"@if( $activite->endroit == "Artistic Beats Pavilion") selected @endif>Artistic Beats Pavilion</option>
                            <option value="Street Art Soundstage"@if( $activite->endroit == "Street Art Soundstage") selected @endif>Street Art Soundstage</option>
                            <option value="Vibrant Vibes Arena"@if( $activite->endroit == "Vibrant Vibes Arena") selected @endif>Vibrant Vibes Arena</option>
                            <option value="Funky Graffiti Groove"@if( $activite->endroit == "Funky Graffiti Groove") selected @endif>Funky Graffiti Groove</option>
                            <option value="The Creative Rhythm Zone"@if( $activite->endroit == "The Creative Rhythm Zone") selected @endif>The Creative Rhythm Zone</option>
                            <option value="Epic Urban Art Beats"@if( $activite->endroit == "Epic Urban Art Beats") selected @endif>Epic Urban Art Beats</option>
                        </select>
                    </div>
                </div>
