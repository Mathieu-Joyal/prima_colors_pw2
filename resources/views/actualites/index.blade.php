        ...
        <section class="conteneur-actualites">
            ...
            <div class="conteneur-bordure">
                ...
                <div class="titre 2022">
                    <h2>
                        <span style="--delay: 0.6s">N</span><span style="--delay: 0.7s">o</span><span
                            style="--delay: 0.8s">u</span><span style="--delay: 0.9s">v</span><span
                            style="--delay: 1s">e</span><span style="--delay: 1.1s">a</span><span
                            style="--delay: 1.2s">u</span><span style="--delay: 1.3s">t</span><span
                            style="--delay: 1.4s">é</span>
                        <span style="--delay: 1.5s"> </span><span style="--delay: 1.6s">d</span><span
                            style="--delay: 1.7s">e</span>
                        <span style="--delay: 1.8s"> </span><span style="--delay: 1.9s">l</span><span
                            style="--delay: 2s">a</span>
                        <span style="--delay: 2.1s"> </span><span style="--delay: 2.2s">s</span><span
                            style="--delay: 2.3s">c</span><span style="--delay: 2.4s">è</span><span
                            style="--delay: 2.5s">n</span><span style="--delay: 2.6s">e</span>
                        <span style="--delay: 2.7s"> </span><span style="--delay: 2.8s">2</span><span
                            style="--delay: 2.9s">0</span><span style="--delay: 3s">2</span><span
                            style="--delay: 3.1s">3</span>
                    </h2>
