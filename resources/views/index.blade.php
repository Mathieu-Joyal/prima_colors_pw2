<x-layout titre="Festival Prima-Colors | Accueil">
    ...
    <p>Entrez dans un univers de créativité et de couleurs au festival Prima-Color ! <br> Vous êtes convié à une
        expérience
    ...
    <div class="section_forfaits">
        ...
        {{-- <a href="/billets">Voir les forfaits!</a> --}}
    </div>

    <div class="section_apropos">
        <img src="img/accueil/forfaits.jpg" alt="">
        <h3>phrase d'accroche de qui sommes nous</h3>
        <p>En savoir plus!</p>
        {{-- <a href="/billets">Voir les forfaits!</a> --}}
    </div>
